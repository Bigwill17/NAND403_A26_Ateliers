import sys
from PySide6.QtWidgets import QApplication, QTableWidget, QTableWidgetItem, QMessageBox
import json

#Je ne sais toujours pas exactement ce que c'est exactement, mais il nous faut ça à la fin pour afficher le tableau
app = QApplication(sys.argv)

#try et except permettent de vérifier si le code est fonctionnel avant de runner le programme
try:
